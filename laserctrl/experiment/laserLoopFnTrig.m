...
elseif lsrL.DICode==61 %trial start
    ...
    lsrL.blueLED = 0;
    lsrL.lsrON =  false;
elseif lsrL.DICode==60 %trial end
...
if ~ lsrL.lsrON && lsrL.locationIdx ~= 0 %galvo move even laser is off
...
t1=toc; %t2 is the time to save the log, this is the critical part
